...
CL_CIFAR_ICREMENTAL_CLASS_OUTPUTS = "/home/hikmat/Desktop/GlobXAI/VariationalPrototypeReplaysCL/ContinuumBench/CIFAR100/Continual-Learning-Benchmark/scripts/outputs/split_CIFAR100_incremental_class/"
...
if __name__ == '__main__':
    ...
    for reg_coef in reg_coef_list:
        ...
        for r in range(args.repeat):
            ...
            path = os.path.join(CL_CIFAR_ICREMENTAL_CLASS_OUTPUTS,
