...
dataset = 'permuted_MNIST_incre_domain';
dataset = 'permuted_MNIST_incremental_domain';

% baseline = {'VPNet','EWC_online','EWC','L2','MAS','SI','NormalNN'}; %'NormalNN',
baseline = {'VPNet','EWC_online','EWC', 'SI', 'L2','ICARL-BCE','ICARL-MSE','MAS'}%'MAS','SI','NormalNN', 'ICARL-BCE'}; %'NormalNN', Naive_Rehearsal_4000,Naive_Rehearsal_16000, ICARL-BCE
baseline = {'SI'}%'MAS','SI','NormalNN', 'ICARL-BCE'}; %'NormalNN', Naive_Rehearsal_4000,Naive_Rehearsal_16000, ICARL-BCE
...
folderbase = '/home/hikmat/Desktop/GlobXAI/VariationalPrototypeReplaysCL/MINSTpermuted/Continual-Learning-Benchmark-master/outputs/';
folderbase = '/home/hikmat/Desktop/GlobXAI/VariationalPrototypeReplaysCL/Continual-Learning-Benchmark/scripts/outputs/';
n_class = 10;
n_task = 5%50;
n_repeats = 10;
...
set(gca,'TickDir','out');
set(gca,'Box','Off');
% baseline = {'VPNet','EWC_online','EWC','L2','MAS','SI','NormalNN', 'Naive_Rehearsal_4000', 
%     'ICARL-BCE'};
legend({ 'SI','Chance'},'Location','southwest');
...
% baseline = {'VPNet','EWC_online','EWC','L2','MAS','SI','NormalNN', 'Naive_Rehearsal_4000', 
%      'ICARL-BCE'};
legend({'VPNet','EWC_online','EWC', 'SI', 'L2','ICARL-BCE','ICARL-MSE','MAS', 'Chance'},'Location','southwest');
